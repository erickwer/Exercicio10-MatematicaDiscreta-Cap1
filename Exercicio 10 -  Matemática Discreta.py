...
# Pertinencia (funciona com lista)
a = {1, 2, 3, 4}
...
# Continencia (intersection não serve pra lista)
...
# Subconjunto (issubset não serve pra lista)
a = {1, 2, 3, 4, 5}
c = {1, 2, 3, 4}
print('O conjunto C é Subconjunto de A? ', c.issubset(a))


# Igualdade (na lista a ordem dos itens importa)
a = {4, 2, 3, 1, 8}
c = {4, 3, 1, 2, 8}
if a == c:
    print("Igual")
